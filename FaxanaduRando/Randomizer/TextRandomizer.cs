        ...
        public bool UpdateText(ShopRandomizer shopRandomizer, GiftRandomizer giftRandomizer, DoorRandomizer doorRandomizer, byte[] content)
        {
            ...
            if (GeneralOptions.UpdateMiscText)
            {
                ...
                if (giftRandomizer.ItemDict.TryGetValue(GiftItem.Id.FireMage, out giftItem))
                {
                    ...
                    var text = $"{giftItem.Item} for‰{cost}?ˆ";
                    allText[22] = text;
                }

                if (giftRandomizer.ItemDict.TryGetValue(GiftItem.Id.FortressGuru, out giftItem))
                {
                    var text = $"Have you‰activated the‰sky spring?‰Come back for‰{giftItem.Item}ˆ";
                    allText[83] = text;
                }
                ...
                if (giftRandomizer.ItemDict.TryGetValue(GiftItem.Id.ConflateGuru, out giftItem))
                {
                    ...
                    if (Util.GurusShuffled())
                    {
                        ...
                        text = $"This guru has‰{giftItem.Item}‰and is at‰{location}ˆ";
                    }
                    allText[131] = text;
                    allText[132] = text;
                    allText[133] = text;
                ...
                {
                    var text = $"Do you have the‰Dragon Slayer?‰Come back for‰{giftItem.Item}ˆ";
                    allText[160] = text;
                }
                ...
                allText[86] = "Hiˆ"; //Sky fountain
                allText[125] = "Hiˆ"; //Ace key guy
                allText[139] = "Hiˆ"; //Conflate guru
                allText[161] = "Hiˆ"; //Fraternal guru
