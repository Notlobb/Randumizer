...
namespace FaxanaduRando.Randomizer
{
    ...
    public static class ItemNameRandomizer
    {
        ...
        {
            { Item.HandDagger, new List<string> { "Hand Dagger", "Iron Dagger", "Quick Blade", "Small Stab",
            "Nand Dagger", "Knife"} },
            { Item.LongSword, new List<string> { "Long Sword", "Steel Blade", "Le Sword Long", "XL Tooth Pick",
            "Short Sword", "Falchion", "Scimitar", "Sabre", "Rapier"} },
            ...
            "Not a shield"} },
            { Item.Deluge, new List<string> { "Deluge", "Flamey Boi", "Fireball", "Blastin", "The Luge", "Fire Flood", "Spark", "Inferno", "Lighter", "Fir2", "Nuke", "Firaga", "Doodahleedoo",
            "op spell", "op magic"} },
            ...
            { Item.Tilte, new List<string> { "Tilte", "Tilto", "Tilta", "Tilti", "Title", "Tickle",
            "Tilted", "OnTilte"} },
            ...
            { Item.KeyK, new List<string> { "Key K", "King Key", "2King2Furious", "King Ski", "Key of Key", "Key Key", "Key of K", "Key of Kings", "Key of King", "Kefka Key",
            "Kinky"} },
            { Item.KeyQ, new List<string> { "Key Q", "Quest Key", "Quick Key", "Cuke Key", "Queen Key", "Quality Key", "Quake Key", "Quail Key", "Quirk Key", "Quiet Key",
            "Killer Queen"} },
            ...
            { Item.Mattock, new List<string> { "Mattock", "Mining Pick", "Matlock", "Tockmat", "Maaaatlooock", "Lawyer Key", "Tooth Pick", "Lock Pick",
            "Pickaxe", "Maaaattooock"} },
            { Item.Rod, new List<string> { "Magical Rod", "Rod", "Oak Steak", "Regular Rod", "Normal Rod", "Inanimate Rod", "Carbon Rod", "Cattle Prod",
            "Oak Stake"} },
            ...
            { Item.BlackPotion, new List<string> { "Black Potion", "Mana Potion", "Guinness", "Coffee", "Carob Juice",
            "Green potion", "Brown potion"} },
            ...
            { Item.BlackOnix, new List<string> { "Black Onix", "Dark Gem", "Shadow Stone", "Night Crystal", "Black Onyx",
            "ShinyOnix"} },
            { Item.FireCrystal, new List<string> { "Fire Crystal" } },
            { Item.Ointment, new List<string> { "Ointment", "Goo", "Vapo Rub", "Maple Syrup", "Star Salve", "Exfoliant",
            "Myrrh", "Lotion"} },
